...
const LINKS: Record<'github' | 'npm' | 'discord' | 'wechatGroupImage', string> & { docs: Record<Locale, string> } = {
  ...
  wechatGroupImage: '/contact/nextclaw-contact-qq-group.jpg',
  docs: {
...
const COPY: Record<Locale, LandingCopy> = {
  ...
  zh: {
    ...
    footerNpm: 'NPM',
    footerDiscord: 'Discord',
    footerWechatGroup: 'QQ群',
    communityTitle: '加入社群',
    communitySubtitle: '国内用户可扫码加入 QQ 群，海外与英文用户欢迎来 Discord。',
    communityWechatLabel: 'QQ群二维码',
